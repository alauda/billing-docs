...
- **Alauda Container Platform Cost Management Server**: You need to install this plugin in arbitrary cluster in order to use the platform's metering and billing functions.
