...
## Install the Cost Management Essential Plugin via Console

### Prerequisites

The **Cost Management Essential Plugin** needs to integrate with the **Cost Management Server** component. So you need to install the **Cost Management Server plugin**   first.
...
## Install the Cost Management Essential Plugin via YAML
